...
def test_process_message():
    json_file = open(
        "/Users/udaykiranchokkam/DWP-Workspace/dataworks-data-egress/tests/sqs_message.json"
    )
...
def test_process_message_with_error():
    json_file = open(
        "/Users/udaykiranchokkam/DWP-Workspace/dataworks-data-egress/tests/sqs_message_no_records.json"
    )
    message_body = json.load(json_file)
    response = {"Messages": [{"Body": json.dumps(message_body)}]}
...
def test_process_message_wrong_formatted_prefix_1():
    json_file = open(
        "/Users/udaykiranchokkam/DWP-Workspace/dataworks-data-egress/tests/sqs_message_wrong_formatted_prefix_1.json"
    )
    message_body = json.load(json_file)
    response = {"Messages": [{"Body": json.dumps(message_body)}]}
    s3_prefixes = sqs_listener.process_messages(response["Messages"])
...
def test_process_message_wrong_formatted_prefix_2():
    json_file = open(
        "/Users/udaykiranchokkam/DWP-Workspace/dataworks-data-egress/tests/sqs_message_wrong_formatted_prefix_2.json"
    )
    message_body = json.load(json_file)
    response = {"Messages": [{"Body": json.dumps(message_body)}]}
    s3_prefixes = sqs_listener.process_messages(response["Messages"])
